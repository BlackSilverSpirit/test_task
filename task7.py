...
new_file_1 = open(file_1,'w')
new_file_2 = open(file_2,'w')
new_file_3 = open(file_3,'w')
new_file_4 = open(file_4,'w')
new_file_5 = open(file_5,'w')
...
text_1 = ''.join(result[0])
text_2 = ''.join(result[1])
text_3 = ''.join(result[2])
text_4 = ''.join(result[3])
text_5 = ''.join(result[4])

new_file_1.write(text_1)
new_file_2.write(text_2)
new_file_3.write(text_3)
new_file_4.write(text_4)
new_file_5.write(text_5)
